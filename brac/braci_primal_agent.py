...
class Agent(agent.Agent):
  ...
  def _div_estimate(self, s, actions, log_pi_actions):
    return self._divergence.primal_estimate_internal(
        s, self._p_fn, actions, log_pi_actions, self._n_div_samples,
  ...
  def _build_q_loss(self, batch):
    ...
    if self._value_penalty:
      div_estimate = self._div_estimate(s2, a2s, log_pi_a2s)
  ...
  def _build_p_loss(self, batch):
    ...
    div_estimate = self._div_estimate(s, a1s, log_pi_a1s)
    q_start = tf.cast(
